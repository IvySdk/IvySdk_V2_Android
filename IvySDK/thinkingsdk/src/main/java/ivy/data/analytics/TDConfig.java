...
import ivy.data.analytics.data.TDContextConfig;
import ivy.data.analytics.persistence.ConfigStoragePlugin;
import ivy.data.analytics.persistence.LocalStorageType;
import ivy.data.analytics.utils.DNSServiceManager;
import ivy.data.analytics.utils.TDUtils;
import ivy.data.analytics.encrypt.TDSecreteKey;
...
public class TDConfig {
    public static final String VERSION = "1.0.0";//BuildConfig.VERSION_NAME;
