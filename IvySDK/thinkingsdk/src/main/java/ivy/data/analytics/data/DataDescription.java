...
import ivy.data.analytics.utils.TDTimeCalibrated;
import ivy.data.analytics.utils.TDTimeConstant;
...
public class DataDescription {
    ...
    public JSONObject get() {
        ...
        try {
            ...
            //  It may be blocked
            finalData.put(TDConstants.KEY_TIME_LOCAL, mTime.getTime());
            finalData.put(TDConstants.KEY_TIME, mTime.getUTCTime());
            finalData.put(TDConstants.KEY_TIME_ST, mTime.getTimeMilliseconds());
...
//            }
            ...
            Iterator<String> iterator = mProperties.keys();
