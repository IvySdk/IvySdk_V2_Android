...
public class TDConstants {
    ...
    public static final String KEY_TIME = "created_date";
    public static final String KEY_TIME_LOCAL = "created_date_local";
    public static final String KEY_TIME_ST = "st";
    ...
    public static final String KEY_SCREEN_HEIGHT = "display_height";
    public static final String KEY_SCREEN_WIDTH = "display_width";
    public static final String KEY_CARRIER = "carrier";
    public static final String KEY_DEVICE_ID = "device_id";
    public static final String KEY_SYSTEM_LANGUAGE = "os_language";
    public static final String KEY_LIB = "lib";
    public static final String KEY_LIB_VERSION = "lib_version";
    public static final String KEY_OS = "os";
    public static final String KEY_BUNDLE_ID = "package_name";
    ...
    public static final String KEY_INSTALL_TIME = "installed_date";
    public static final String KEY_INSTALL_TIME_IT = "it";
    public static final String KEY_UPDATED_TIME = "updated_date";
    public static final String KEY_UPDATED_TIME_UT = "ut";
    ...
    public static final String TIME_CHECK_PATTERN = "\\d{4}-\\d{2}-\\d{2}";
    // This command is used to remove reload from the server
    public static final String DATA_ID = "android_uuid";
